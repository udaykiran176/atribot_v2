...
import { ScrollingTopics } from "@/components/marketing/scrolling-topics";
...
export default async function MarketingPage() {
  ...
  return (
    <>
    <div className="mx-auto flex w-full max-w-[988px] flex-1 flex-col items-center justify-center gap-0 p-8  lg:flex-row-reverse">
